...
const mencoat: React.FC = () => {
  const initialProducts: Product[] = [
    {
      image: "src/assets/images/products/mencoat1.jpg",
      brandName: "Louis Phillipie Tuxedo(midnight black)",
    ...
    {
      image: "src/assets/images/products/mencoat2.png",
      brandName: "Raymond Office Suit (black)",
      sizes: ["37", "38", "39", "40", "41"],
    ...
    {
      image: "src/assets/images/products/mencoat3.png",
      brandName: "Peter England Grey Formal Suit",
    ...
    {
      image: "src/assets/images/products/mencoat4.png",
      brandName: "Manyavar Blue Suit Full Set",
  ...
  const handleClick = (index: number) => {
    ...
    return (
      ...
      <div className="relative z-10">
        <Navbar />
        <h3 className="text-orange-300 text-5xl p-4 font-mono ml-24 font-semibold">MEN'S FORMALS</h3>
