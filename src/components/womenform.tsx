...
const womenform: React.FC = () => {
  const initialProducts: Product[] = [
    {
      image: "src/assets/images/products/womencoat.jpg",
      brandName: "Allen Solly office wear (cream + black)",
    ...
    {
      image: "src/assets/images/products/womencoat2.png",
      brandName: "Bewakoof Womens formal coat(burnt orange)",
      sizes: ["37", "38", "39", "40", "41"],
    ...
    {
      image: "src/assets/images/products/womencoat3.png",
      brandName: "Vihara's women full suit (white)",
    ...
    {
      image: "src/assets/images/products/womencoat4.png",
      brandName: "Cardini's women full suit (rosepink-white)",
  ...
  const handleClick = (index: number) => {
    ...
    return (
      ...
      <div className="relative z-10">
        <Navbar />
        <h3 className="text-orange-300 text-5xl p-4 font-mono ml-24 font-semibold">WOMEN'S FORMALS</h3>
