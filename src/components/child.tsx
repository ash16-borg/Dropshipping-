...
const child: React.FC = () => {
  const initialProducts: Product[] = [
    {
      image: "src/assets/images/products/child1.png",
      brandName: "Freesbie white frock",
    ...
    {
      image: "src/assets/images/products/child2.png",
      brandName: "First cry floral printed blue frock",
      sizes: ["37", "38", "39", "40", "41"],
    ...
    {
      image: "src/assets/images/products/child3.png",
      brandName: "Deep blue cotton baby-frock",
    ...
    {
      image: "src/assets/images/products/child4.png",
      brandName: "Girl Top's blue and white",
  ...
  const handleClick = (index: number) => {
    ...
    return (
      ...
      <div className="relative z-10">
        <Navbar />
        <h3 className="text-orange-300 text-5xl p-4 font-mono ml-24 font-semibold">KID'S WEAR</h3>
